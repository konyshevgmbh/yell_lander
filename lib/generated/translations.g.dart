...
///
/// Locales: 6
/// Strings: 96 (16 per locale)
///
/// Built on 2025-05-11 at 20:22 UTC
...
import 'translations_cn.g.dart' deferred as l_cn;
...
enum AppLocale with BaseAppLocale<AppLocale, Translations> {
	...
	Future<Translations> build({
		...
		switch (this) {
			...
			case AppLocale.cn:
				await l_cn.loadLibrary();
				return l_cn.TranslationsCn(
					overrides: overrides,
					cardinalResolver: cardinalResolver,
					ordinalResolver: ordinalResolver,
				);
